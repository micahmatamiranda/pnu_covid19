<section id="help" class="help section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Helpful Links</h2>
          <p>Here are some links that you may find helpful:</p><br>
          <ul>
          ...
          <br>
          <p>If you have some helpful links that you want to see listed here, please send an email to <strong>mis@pnu.edu.ph</strong>.</p>
        </div>
      </div>
    </section>